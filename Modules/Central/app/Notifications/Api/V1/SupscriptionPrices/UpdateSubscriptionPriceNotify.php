...
class UpdateSubscriptionPriceNotify extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject(' Subscription Price Updated')
            ->greeting('Hello!')
            ->line('A new subscription price has been updated successfully.')
