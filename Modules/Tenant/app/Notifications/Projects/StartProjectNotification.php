...
class StartProjectNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable): MailMessage
    {
        $mail = (new MailMessage)
            ->subject('Project Started - ' . $this->name_en)

            ->greeting('Hello ' . ($notifiable->user?->name ?? 'there') . ',')

            ->line('A project has been successfully started.')
