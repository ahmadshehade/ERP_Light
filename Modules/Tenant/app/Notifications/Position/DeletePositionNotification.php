...
class DeletePositionNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable): MailMessage
    {
        ...
        $mail = (new MailMessage)
            ...
            ->line('A position has been deleted from your company.')
        ...
        $mail->line('Status before deletion: ' . $status);
