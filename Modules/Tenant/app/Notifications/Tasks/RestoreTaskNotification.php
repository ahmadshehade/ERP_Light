...
class RestoreTaskNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line(
                "A new task has been Restored in {$this->company_name_en}."
            )
